...
@Component({
  selector: 'app-slider-geio',
  templateUrl: './slider.component.html',
  styleUrls: ['./slider.component.scss']
})
export class SliderGEIOComponent implements OnInit {
  ...
  @Inject(WINDOW) private window, private fix: LandingFixService, private domainUrl: DomainURL) { }
