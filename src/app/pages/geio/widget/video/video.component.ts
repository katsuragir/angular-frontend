...
@Component({
  selector: 'app-video-geio',
  templateUrl: './video.component.html',
  styleUrls: ['./video.component.scss'],
  providers: [ProductsService, CartService, WishlistService]
})
export class VideoGeioComponent implements OnInit {
  ...
  constructor(private router: Router, @Inject(DOCUMENT) private document: Document, private sanitizer: DomSanitizer,
  private fix: LandingFixService, @Inject(WINDOW) private window, private domainUrl: DomainURL) {
