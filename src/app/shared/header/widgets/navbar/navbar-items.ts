...
export const MENUITEMS: Menu[] = [
	{
		title: 'Product', type: 'sub', children: [
	      { path: '/pages/geio', title: 'GEIO', type: 'link' },          
		  { path: '/pages/ganker-ex', title: 'GANKER EX', type: 'link'},         
		  /*
	...
	{
		path: '/pages/press', title: 'Press', type: 'link'
		/* children: [
	...
	{
		path: '/pages/support', title: 'Support', type: 'link' /*, megaMenu: true, megaMenuType: 'medium', children: [
	...
	{
		path: '/pages/about', title: 'About', type: 'link' /*, children: [
