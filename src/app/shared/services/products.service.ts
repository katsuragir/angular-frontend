...
import { Robots } from '../classes/robots';
...
export class ProductsService {
  ...
  // Observable Product Array
  private robotss(): Observable<Robots[]> {
    return this.http.get('assets/data/robots.json').map((res:any) => res.json())
 }
  ...
  // Get Products
  public getRobots(): Observable<Product[]> {
    return this.robotss();
  }
